function initialize() {
	...
	for (let i = 0; i < locationInputs.length; i++) {
		...
		const latitude = parseFloat(document.getElementById(fieldKey + "_latitude").value) || -6.5801583;
		const longitude = parseFloat(document.getElementById(fieldKey + "_longitude").value) || 106.7963238;
