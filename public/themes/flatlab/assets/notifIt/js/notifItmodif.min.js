!(function (t, i) {
  if ("function" == typeof define && define.amd) define(i);
    ...
    var n = i(t.b);
    (t.notif = n.notif), (t.notif_confirm_modif = n.notif_confirm_modif), (t.notif_prompt = n.notif_prompt);
  }
})(this, function () {
  function t(t) {
    var i = function () {
  ...
  function i(t) {
    function i() {
      if (null !== f) return f;
      var t = s("<button>", { class: "notifit_confirm_accept1", text: l.textaccept }),
		u = s("<button>", { class: "notifit_confirm_accept2", text: l.textaccept1 }),
        i = s("<button>", { class: "notifit_confirm_cancel", text: l.textcancel }),
        n = s("<div>", { class: "notifit_confirm_message", html: l.message });
      return (f = s("<div>", { class: "notifit_confirm" })), f.append(n).append(t).append(u).append(i), (r = s("<div>", { class: "notifit_confirm_bg" })), f;
    }
    function n() {
      f &&
        (l.fullscreen
    ...
    function a() {
      o();
      var t = null;
      return s(this).hasClass("notifit_confirm_accept1") ? (t = !0) : s(this).hasClass("notifit_confirm_accept2") && (t = !1), "function" == typeof l.callback ? l.callback(t) : t;
    }
    function e() {
      s("html").one("click", ".notifit_confirm_accept1, .notifit_confirm_accept2, .notifit_confirm_cancel", a);
    }
    var s = jQuery,
  ...
  function n(t) {
    ...
    function a() {
      ...
      var t = null;
      return (
        s(this).hasClass("notifit_prompt_accept") ? (t = s(this).parents(".notifit_prompt").find(".notifit_prompt_input").val()) : s(this).hasClass("notifit_prompt_cancel") && (t = !1), "function" == typeof l.callback ? l.callback(t) : t
      );
    }
    function e() {
  ...
  return { notif: t, notif_confirm_modif: i, notif_prompt: n };
});
